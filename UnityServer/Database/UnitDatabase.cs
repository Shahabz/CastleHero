...
class UnitDatabase
{
    ...
    public void InitializeUnitDatabase()
    {
        ...
        unitData.Add(new UnitBaseData(UnitId.Archer, "Archer", "활을 쏘는 궁수이다. 원거리 전투에 효과적이다.", new TimeSpan(0, 0, 90), 250, 18));
        ...
        unitData.Add(new UnitBaseData(UnitId.Paladin, "Paladin", "망치를 들고있는 팔라딘이다. 마법 방어력이 뛰어나다", new TimeSpan(0, 0, 300), 500, 18));
        ...
        unitData.Add(new UnitBaseData(UnitId.Mage, "Mage", "마법을 사용하는 마법사이다. 강력한 화염마법을 구사한다.", new TimeSpan(0, 0, 600), 750, 18));
        ...
        unitData.Add(new UnitBaseData(UnitId.Knight, "Knight", "기동력이 뛰어난 기사이다. 근접 전투와 체력이 뛰어나다.", new TimeSpan(0, 0, 900), 1000, 18));
